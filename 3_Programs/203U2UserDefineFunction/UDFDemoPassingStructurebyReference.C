...
we will be able to pass Structure object as 
Reference to the function and display the 
...
int main() {
    ...
    // Displaying updated marks to show that the original structure is changed
